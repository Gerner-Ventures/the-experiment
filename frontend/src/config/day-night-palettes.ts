...
export const PHASE_ARC_POSITIONS: Record<RoundPhase, number> = {
  ...
  dawn: 0.1,         // sun just above left horizon
  morning: 0.3,      // sun climbing
  midday: 0.5,       // sun at apex
  afternoon: 0.75,   // sun descending
...
const PALETTES: ThemeDayNightPalette[] = [
  {
    ...
    phases: {
      ...
      afternoon: { skyTop: '#e09050', skyBottom: '#f0c890', filterBrightness: 0.8,  sunAlpha: 0.7, moonAlpha: 0, starOpacity: 0 },
      night:     { skyTop: '#0a1428', skyBottom: '#1a2040', filterBrightness: 0.45, sunAlpha: 0,   moonAlpha: 0.9, starOpacity: 1.0 },
    },
  },
  {
    themeId: 'matrix',
    ...
    phases: {
      ...
      night:     { skyTop: '#000400', skyBottom: '#000800', filterBrightness: 0.7,  sunAlpha: 0,   moonAlpha: 0.8, starOpacity: 0 },
    },
  },
  {
    themeId: 'gladiator',
    ...
    phases: {
      ...
      afternoon: { skyTop: '#cc8855', skyBottom: '#ddbb88', filterBrightness: 0.75, sunAlpha: 0.6, moonAlpha: 0, starOpacity: 0 },
      night:     { skyTop: '#0f0a1e', skyBottom: '#1a1030', filterBrightness: 0.4,  sunAlpha: 0,   moonAlpha: 0.9, starOpacity: 1.0 },
    },
  },
  {
    themeId: '1984',
    ...
    phases: {
      ...
      afternoon: { skyTop: '#443322', skyBottom: '#664433', filterBrightness: 0.7,  sunAlpha: 0.5, moonAlpha: 0, starOpacity: 0 },
      night:     { skyTop: '#050308', skyBottom: '#0a0510', filterBrightness: 0.3,  sunAlpha: 0,   moonAlpha: 0.4, starOpacity: 0.6 },
    },
  },
]
